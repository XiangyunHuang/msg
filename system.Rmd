...
```{r lattice-data-par, fig.scap="(ref:lattice-data-par-s)",fig.cap="(ref:lattice-data-par)",fig.subcap=c("",""),fig.ncol=1,fig.width=4.8,fig.height=2.2, out.width="80%", fig.show='hold'}
msg_graph("lattice-data-par")
```
