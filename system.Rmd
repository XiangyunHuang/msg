...
```{r plotly-histogram-web,eval=FALSE}
# 生成一些随机数
...
```
```{r plotly-histogram-svg, echo=FALSE, fig.cap="交互式直方图", out.extra=ifelse(is_latex,'','data-url="interactives/plotly-histogram.html"')}
knitr::include_graphics(path = append_ext("interactives/plotly-histogram"))
```
...
knitr::include_graphics(path = append_ext("interactives/plotly-heatmap-contour"))
```
...
knitr::include_graphics(path = append_ext("interactives/heatmaply"))
```
...
knitr::include_graphics(path = append_ext("interactives/plotly-china-map"))
```
...
knitr::include_graphics(path = append_ext("interactives/faithful"))
```
