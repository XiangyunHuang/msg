...
[gganimate 动画制作，介绍 tweenr 通过插值生成中间过渡帧]{.todo}

这个例子源于余光创的博客<https://guangchuangyu.github.io/cn/2017/09/3d-breast/>。
...
```{r,fig.showtext=FALSE,cache=FALSE,dev='png'}
# 动画效果
library(gganimate)
ggplot(data = dat2, aes(x, y, color = I(cols))) +
  geom_path(na.rm = TRUE) +
