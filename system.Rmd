...
```{r lattice-iris-hist,fig.width=6, fig.height=3, fig.cap="(ref:lattice-iris-hist)",fig.scap="(ref:lattice-iris-hist-s)"}
...
```{r lattice-panel-function,fig.width=6, fig.height=3, fig.scap="(ref:lattice-panel-function-s)",fig.cap="(ref:lattice-panel-function)"}
