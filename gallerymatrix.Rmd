...
```{r matplot2,fig.width=4.8,fig.height=3,out.width="80%", echo=TRUE}
...
View[^cran-taskview]），这是一个很好的导航页面，它总结了一些有用的包的功能。对于具体的问题，也可以广泛寻求网络上的帮助和指导（参见 \@ref(sec:R-intro) 小节）。
...
```{r contour-persp, fig.height=6,fig.width=7,out.width="80%", fig.cap="(ref:fig-contour-persp)",fig.scap="(ref:fig-contour-persp-s)"}
