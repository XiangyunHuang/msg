...
```{r fig-ggally, echo=TRUE, fig.height=10, fig.width=10, fig.cap="(ref:fig-pairs2)", fig.scap="(ref:fig-pairs2-s)"}
library(ggplot2)
library(GGally)
...
kable2(ChinaPop, "我国 31 省市自治区的人口特征数据")
```
...
```{r symbols,fig.width=6,fig.height=6,fig.cap="(ref:fig-symbols)",fig.scap="(ref:fig-symbols-s)"}
