...
截至 2019 年 8 月 25 日， [黄湘云](https://github.com/XiangyunHuang) 和 [赵鹏](https://github.com/pzhaonet) 将 [谢益辉](https://github.com/yihui) 的书稿从 LyX 搬迁到 bookdown，并完成修订工作，期间有来自 [Song Li](https://github.com/boltomli)、 [JackieMe](https://github.com/JackieMium) 的帮助，在此表示感谢，我们欢迎更多的人参与改进本书。目前书籍的写作和维护由黄湘云和赵鹏负责。
