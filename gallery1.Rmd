...
```{r dotchart2, fig.width=4.8,fig.height=2.7,fig.cap="(ref:fig-dotchart2)",fig.scap="(ref:fig-dotchart2-s)"}
msg_graph("dotchart2")
```
...
```{r nightingale-ggplot2, fig.width=10, fig.cap="(ref:nightingale-ggplot2)",fig.scap="(ref:nightingale-ggplot2-s)"}
