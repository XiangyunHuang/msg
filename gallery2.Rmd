...
```{r sunflowerplot,fig.width=4,fig.height=4,out.width="70%", fig.cap="(ref:fig-sunflowerplot)",fig.scap="(ref:fig-sunflowerplot-s)", dev='tikz', fig.showtext = FALSE}
...
```{r survival,fig.width=4.8,fig.height=3,out.width="80%", fig.cap="(ref:fig-survival)",fig.scap="(ref:fig-survival-s)",fig.show="hold", dev='tikz', fig.showtext = FALSE}
msg_graph("survival2")
```
...
```{r cdplot,fig.width=4.8,fig.height=2.4, out.width="80%", fig.cap="(ref:fig-cdplot)", fig.scap="(ref:fig-cdplot-s)", dev='tikz', fig.showtext = FALSE}
msg_graph("cdplot2")
```
...
```{r spineplot,fig.width=4.8,fig.height=3,out.width="75%",fig.cap="(ref:fig-spineplot)",fig.scap="(ref:fig-spineplot-s)", dev='tikz', fig.showtext = FALSE}
msg_graph("spineplot")
```
...
```{r bagplot,fig.width=7,fig.height=3,fig.cap="(ref:fig-bagplot)",fig.scap="(ref:fig-bagplot-s)", dev='tikz', fig.showtext = FALSE}
msg_graph("bagplot2")
```
