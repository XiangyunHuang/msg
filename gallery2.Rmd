...
(ref:fig-windrose) 伦敦 Marylebone 的风玫瑰图：将风向分为 12 个（左）或 16 个（右）方向，每个方向用一根“指针”（左）或一个扇形（右）来表示该方向上风力的具体情况。从图中可以看出，该地区最常刮西南偏南风，因为该方向的扇环半径最长，或者指针最长；相对来说东南风较少。无风的频率大约是 0.3 \%
...
(ref:fig-bagplot-s) *Consumer Reports* 杂志 中汽车数据的二维箱线图和密度等高图
